...
- Connect an oscilloscope to monitor the PORT pin PA17 (EXT1 header)
...
| ---------- | ---------------- |--------- |
| [SAM G55 Xplained Pro Evaluation Kit](https://www.microchip.com/developmenttools/ProductDetails/atsamg55-xpro) | PA17 (Pin #3 on the EXT1 header)  | LED0 |
|||
