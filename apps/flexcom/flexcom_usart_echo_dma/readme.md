...
# FLEXCOM USART with DMA

This example application shows how to use the flexcom module in USART DMA mode.

## Description

This application configures the flexcom peripheral in USART DMA mode and performs read and write operation in a non-blocking manner. It receives 10 characters from the terminal window and echoes them back.
...
Path of the application within the repository is **apps/flexcom/flexcom_usart_echo_dma/firmware** .
...
4. The console displays the following message
    ...
    ![output](images/output_flexcom_usart_echo_dma.png)
