...
- TC0_CH0  generates the PWM waveform on pin PA00
- TC0_CH1 is configured in capture mode with the input signal connected to pin PA23
- Use a jumper wire to connect "Pin 8 of EXT1 (TC0_TIOA1)" to "Pin 7 of EXT1 (TC0_TIOA0)"
